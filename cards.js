...
window.FLASHCARDS = [
  /* ===== 일상 ===== */
  {
    ...
    colloquialSpain: "¿Qué vais a hacer esta noche? Hagamos algo juntos.",
    formalSpain: "¿Qué van a hacer esta noche? Podríamos hacer algo juntos.",
    colloquialLatAm: "¿Qué van a hacer esta noche? Hagamos algo juntos."
  },
  {
    id: 2,
    topics: ["일상"],
    difficulty: "쉬움",
    meaningKo: "컴퓨터가 또 멈췄어. 재부팅해 볼게.",
    colloquialSpain: "El ordenador se ha vuelto a colgar. Voy a reiniciarlo.",
    formalSpain: "El ordenador se ha vuelto a bloquear. Voy a reiniciarlo.",
    colloquialLatAm: "La computadora se volvió a trabar. Voy a reiniciarla.",
    notes: "ordenador = 스페인 / computadora = 중남미"
  },
  {
    id: 3,
    topics: ["일상"],
    ...
    colloquialSpain: "Paso por el súper y compro leche y pan.",
  ...
  },
  {
    ...
    colloquialSpain: "Los vecinos han vuelto a poner la música a todo volumen por la noche y no he pegado ojo.",
    formalSpain: "Los vecinos han vuelto a poner la música a un volumen excesivo por la noche y apenas he dormido.",
    colloquialLatAm: "Los vecinos volvieron a poner la música a todo volumen en la noche y no pegué ojo."
  },
  {
    id: 6,
    topics: ["일상"],
    difficulty: "아주어려움",
    meaningKo: "이번 주말에 집 청소하고 나서 빨래를 다 개어 두면 좋겠어.",
    colloquialSpain: "Este fin de semana me gustaría limpiar la casa y después dejar toda la ropa doblada.",
    formalSpain: "Este fin de semana me gustaría limpiar la casa y, a continuación, dejar toda la ropa doblada.",
    colloquialLatAm: "Este fin de semana me gustaría limpiar la casa y después dejar toda la ropa doblada."
  },
  ...
  },
  {
    ...
    colloquialSpain: "Le he preguntado al jefe si puedo teletrabajar esta semana.",
    formalSpain: "He consultado a mi superior si es posible teletrabajar esta semana.",
    colloquialLatAm: "Le pregunté al jefe si puedo trabajar desde casa esta semana."
  },
  {
    id: 11,
    topics: ["직장"],
  ...
  },
  {
    ...
    colloquialSpain: "Si me pasáis más información sobre el tema, lo miro y os contesto.",
  ...
  },
  {
    ...
    colloquialSpain: "Me preocupa perder la conexión; el tiempo de trasbordo es demasiado corto.",
  ...
  },
  {
    ...
    colloquialLatAm: "¿Me pueden decir dónde se toma el camión / el bus al centro?",
    notes: "스페인: coger el autobús / 멕시코 등: tomar el camión"
  },
  {
    id: 17,
    topics: ["여행"],
    ...
    colloquialSpain: "Como vamos a llegar tarde al alojamiento, confirma cómo recogemos las llaves.",
  ...
  },
  {
    ...
    colloquialLatAm: "¿Nos trae la cuenta, por favor? Vamos a pagar a medias. / a la americana."
  },
  {
    id: 21,
    topics: ["음식"],
    ...
    colloquialLatAm: "¿Me lo puede poner para llevar? / para llevar a domicilio."
  },
  {
    id: 22,
    topics: ["음식"],
    ...
    colloquialLatAm: "Tengo alergia, así que tengo que evitar los platillos con nueces / frutos secos."
  },
  {
    id: 23,
    topics: ["음식"],
  ...
  /* ===== 감정 ===== */
  {
    ...
    colloquialSpain: "Llevo unos días agobiado con el trabajo.",
    formalSpain: "Últimamente me siento agotado debido a la carga de trabajo.",
    colloquialLatAm: "Ando un poco agotado con el trabajo estos días."
  },
  {
    id: 26,
    topics: ["감정"],
    ...
    colloquialSpain: "Me quedo más tranquilo oyendo eso.",
    formalSpain: "Me siento más aliviado al oírlo.",
    colloquialLatAm: "Me quedo más tranquilo oyendo eso."
  },
  {
    id: 27,
    topics: ["감정"],
  ...
  },
  {
    ...
    colloquialSpain: "Estoy agradecido, pero se me da mal expresarlo con palabras.",
    formalSpain: "Siento agradecimiento, aunque me resulta difícil expresarlo con palabras.",
    colloquialLatAm: "Estoy agradecido, pero se me dificulta expresarlo con palabras."
  },
  {
    id: 30,
    topics: ["감정"],
    ...
    colloquialSpain: "A veces necesito estar solo, pero no me gustaría que me dierais la espalda.",
    formalSpain: "En ocasiones necesito estar solo, pero no desearía que se me diera la espalda.",
    colloquialLatAm: "A veces necesito estar solo, pero no me gustaría que me dieran la espalda."
  },
  ...
  /* ===== 관용구 ===== */
  {
    ...
    topics: ["관용구"],
    difficulty: "쉬움",
    meaningKo: "괜찮아, 걱정 마. (직역: 물이 없어 / 문제없다)",
    colloquialSpain: "No pasa nada. / Tranquilo, no hay problema.",
    formalSpain: "No se preocupe; no hay ningún problema.",
    colloquialLatAm: "No pasa nada. / Tranquilo, no hay bronca."
  },
  {
    id: 44,
    topics: ["관용구"],
  ...
  },
  {
    ...
    topics: ["관용구"],
    difficulty: "아주어려움",
    meaningKo: "분위기 파악하다 / 눈치 보다. (직역: 공기가 어디에 있는지 보다)",
  ...
  },
  {
    ...
    colloquialSpain: "Si hay que cuadrar agenda, decídme qué hueco os viene bien.",
